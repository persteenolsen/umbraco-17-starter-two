...
namespace MvcUmbraco.Controllers
{
   // public class EmployeeController : Controller
    public class EmpEditController : RenderController
   
    {
        private readonly MvcAppDbContext _context;

        public EmpEditController(MvcAppDbContext context, ILogger<EmpEditController> logger, ICompositeViewEngine compositeViewEngine, IUmbracoContextAccessor umbracoContextAccessor)
